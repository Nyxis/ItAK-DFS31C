...
class getLuckyControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Cg6rAV4'] ?? $container->load('get_ServiceLocator_Cg6rAV4Service'))->withContext('App\\Controller\\LuckyController', $container));
